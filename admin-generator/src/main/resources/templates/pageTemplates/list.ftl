...
<div id="app" class="container">
        ...
        <section class="content">
            ...
            >
                ...
                <#list table.fields as column>
                    <#if column.comment == ''>
                        <el-table-column prop="${column.propertyName}" label="${column.propertyName}"></el-table-column>
                    <#else>
                        <el-table-column prop="${column.propertyName}" label="${column.comment}"></el-table-column>
                    </#if>
                </#list>
                <el-table-column
                        fixed="right"
    ...
    <el-dialog :title="dialogTitle" :visible.sync="addDialogVisible">
        <el-form :model="itemData">
            ...
            <#list table.fields as column>
                <#if column.keyFlag >
                    <el-form-item label="${column.propertyName}" :label-width="formLabelWidth" style="display: none">
            ...
            <#list table.fields as column>
                <#if column.propertyName != 'isDeleted' && !column.keyFlag>
                    ...
                    <#if column.propertyName?contains('Time')>
                        <el-form-item label="<#if column.comment == ''>${column.propertyName}<#else>${column.comment}</#if>" :label-width="formLabelWidth">
                            <el-date-picker
